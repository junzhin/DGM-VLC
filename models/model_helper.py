...
from models.df_gan import ResnetGenerator_with_text_embeddings3 
...
def define_G(input_nc, output_nc, ngf, netG, norm='batch', use_dropout=False, init_type='normal', init_gain=0.02, gpu_ids=[]):
    ...
    if netG == 'resnet_9blocks':
        ...
        net = UnetGenerator(input_nc, output_nc, 5, ngf,
        ...
        net = Dynet()
    elif netG == 'simple_fcn':
        net = PlainCNN()
    elif netG == 'resnet_9blocks_with_text_encoder':
        net = ResnetGenerator_with_text_embeddings(input_nc, output_nc, ngf, norm_layer=norm_layer, use_dropout=use_dropout, n_blocks=9)
    elif netG == 'resnet_9blocks_with_text_encoder2':
        net = ResnetGenerator_with_text_embeddings2(input_nc, output_nc, ngf, norm_layer=norm_layer, use_dropout=use_dropout, n_blocks=9)
    elif netG == 'resnet_9blocks_with_text_encoder3':
        net = ResnetGenerator_with_text_embeddings3(input_nc, output_nc, ngf, norm_layer=norm_layer, use_dropout=use_dropout, n_blocks=9)
    else:
        raise NotImplementedError(
